...
const CategoryScreen = ({match}) => {
    ...
    const keyword = match.params.keyboard
    ...
    const productCategory = products.filter(item => item.gender === productId)
    
    const sortedCategory = productCategory.sort((a, b)=> (a.category > b.category ? 1:-1))
